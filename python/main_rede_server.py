    ...
    if __name__ == "__main__":
        try:
            ...
            if mydb.is_connected():
                ...
                resultServer = mycursor_server.fetchone()
                ...
                try:
                    ...
                    if result:
                        ...
                        id_maquina_server, fk_empresaServer = resultServer
                        ...
                        while not event.is_set():
                            ...
                            sql_query_network_server = """
                                    INSERT INTO monitoramento (dado_coletado, data_hora, descricao, fk_componentes_monitoramento, fk_maquina_monitoramento, fk_empresa_monitoramento, fk_unidade_medida)
                                    VALUES (%s, %s, 'velocidade de download', (SELECT id_componente from componente WHERE nome_componente = 'REDE' and fk_maquina_componente = %s), %s, %s, (SELECT id_unidade FROM unidade_medida WHERE representacao = %s)),
                                           (%s, %s, 'velocidade de upload', (SELECT id_componente from componente WHERE nome_componente = 'REDE' and fk_maquina_componente = %s), %s, %s, (SELECT id_unidade FROM unidade_medida WHERE representacao = %s)),
                                           (%s, %s, 'ping', (SELECT id_componente from componente WHERE nome_componente = 'REDE' and fk_maquina_componente = %s), %s, %s, (SELECT id_unidade FROM unidade_medida WHERE representacao = %s)),
                                           (%s, %s, 'latencia', (SELECT id_componente from componente WHERE nome_componente = 'REDE' and fk_maquina_componente = %s), %s, %s, (SELECT id_unidade FROM unidade_medida WHERE representacao = %s)),
                                           (%s, %s, 'bytes enviados py', (SELECT id_componente from componente WHERE nome_componente = 'REDE' and fk_maquina_componente = %s), %s, %s, (SELECT id_unidade FROM unidade_medida WHERE representacao = %s)),
                                           (%s, %s, 'bytes recebidos py', (SELECT id_componente from componente WHERE nome_componente = 'REDE' and fk_maquina_componente = %s), %s, %s, (SELECT id_unidade FROM unidade_medida WHERE representacao = %s));
                                           """
                            ...
                            val_network_server = (
                                velocidade_download, data_hora_local, id_maquina_server, id_maquina_server, fk_empresaServer, 'B',
                                velocidade_upload, data_hora_local, id_maquina_server,id_maquina_server, fk_empresaServer, 'B',
                                ping, data_hora_local, id_maquina_server,id_maquina_server, fk_empresaServer, 'MS',
                                latencia, data_hora_local, id_maquina_server,id_maquina_server, fk_empresaServer, 'MS',
                                bytes_enviados, data_hora_local, id_maquina_server,id_maquina_server, fk_empresaServer, 'B',
                                bytes_recebidos, data_hora_local, id_maquina_server,id_maquina_server, fk_empresaServer, 'B'
                            )


                            mycursor.execute(sql_query_network, val_network)
                            mycursor_server.execute(sql_query_network_server, val_network_server)
                            mydb.commit()
                            mydb_server.commit()
                            print(mycursor.rowcount, "registros inseridos no banco (rede)")
                            print(mycursor_server.rowcount, "registros inseridos no banco (rede) remoto")
                            print("\r\n")
                            ...
                            for process in processes:
                                ...
                                if process_info:
                                    ...
                                    print(val_process)
                                    val_process_server = (sent_bytes, received_bytes, pid, id_maquina_server)
                                    print(val_process_server)
                                    
                                    mycursor.execute(sql_query_process, val_process)
                                    mycursor_server.execute(sql_query_process_server, val_process_server)
                                    mydb.commit()
                                    mydb_server.commit()
